...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function lo(e,t,n){return new Oi({name:`SphericalGaussianBlur`,defines:{SAMPLES:Ja,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},sigma:{value:0},mipInt:{value:0}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function uo(){return new Oi({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:po(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function fo(){return new Oi({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:po(),fragmentShader:`
	...
	`}var mo=class extends Kt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new pi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
#ifdef USE_TANGENT
vec3 objectTangent = vec3(tangent.xyz);
#endif`)),e.vertexShader=r};this.material.onBeforeCompile=e=>n(e,!0),this.depthMaterial=new ji({depthPacking:Ie}),this.depthMaterial.onBeforeCompile=e=>n(e,!1),this.body={...ql},this.person={...Jl},this.fit={muscle:.5,weight:.5,local:{}},this.composition={fat:0,muscle:0,training:`mixed`,groups:{},tint:!1},this.voxel=.01,this.view=`look`,this.joints={},this.lengths={foot:.07,thigh:.45,calf:.43},this.armSpread=0,this.stats={total:0,slow:0,fast:0,fat:0,other:0},this.buildMs=0,this.ready=(e?Promise.resolve(e):El()).then(e=>{this.setHuman(e),this.build()})}cubeWeights(e){let t=this.H,n={};for(let r=0;r<4;r++){let i=t.skinW[e*4+r]/255;if(i){let a=Kl[Pl(t.bones[t.skinIdx[e*4+r]].name)];n[a]=(n[a]||0)+i}}let r=Object.entries(n).sort((e,t)=>t[1]-e[1]).slice(0,4),i=r.reduce((e,[,t])=>e+t,0)||1,a=[0,0,0,0],o=[0,0,0,0];return r.forEach(([e,t],n)=>{a[n]=+e,o[n]=t/i}),r.length||(o[0]=1),[a,o]}updateSkin(){if(!this.bindInv)return;this.root.updateMatrixWorld(!0);let e=new Yt().copy(this.root.matrixWorld).invert();Gl.forEach((t,n)=>{let r=this.joints[t];r&&this.boneUniform.value[n].copy(e).multiply(r.matrixWorld).multiply(this.bindInv[n])})}setHuman(e){this.H=e,this.restNormals=Hl(e.base,e.faces,e.N),this.labels=ru(e,this.restNormals),this.fatSet=iu(e),this.vertJoint=Array.from({length:e.N},(t,n)=>Pl(e.bones[e.skinIdx[n*4]].name));let t=e=>/^(head|neck_01|hand|thumb|index|middle|ring|pinky)/.test(e);this.vertDetail=Uint8Array.from({length:e.N},(n,r)=>+!!t(e.bones[e.skinIdx[r*4]].name)),this.vertHand=Uint8Array.from({length:e.N},(t,n)=>+!!/^(hand|thumb|index|middle|ring|pinky)/.test(e.bones[e.skinIdx[n*4]].name))}targetWeights(){let e=this.composition,t=this.fit,n=e.fat>0?e.fat:.5*e.fat,r=(e,t,n)=>Math.min(n,Math.max(t,e)),i=jl({gender:this.person.gender,age:this.person.age,muscle:r(t.muscle+.3*e.muscle,0,1),weight:r(t.weight+.35*n,0,1)}),a={},o=(e,t)=>{a[e]=(a[e]||0)+t};for(let[e,n]of Object.entries(t.local))o(e,n);for(let[e,n]of Object.entries(t.face||{}))o(e,n);let s={};for(let t of tu){s[t]=wl({group:t,slow:nu[t]},e);let n=new Set;for(let{t:e}of $l[t]){if(n.has(e))continue;n.add(e);let r=tu.filter(t=>$l[t].some(t=>t.t===e)).length;o(e,s[t]*.9/r)}}for(let[e,t]of Object.entries(eu))o(e,n*t);let c=[...i];for(let[e,t]of Object.entries(a)){let n=r(t,-1,1);Math.abs(n)<.001||(this.H.targets[e+`-incr`]?c.push([e+(n<0?`-decr`:`-incr`),Math.abs(n)]):this.H.targets[e+`-out`]?c.push([e+(n<0?`-in`:`-out`),Math.abs(n)]):this.H.targets[e]&&c.push([e,Math.max(0,n)]))}return this.gains=s,this.fatGain=n,c}shape(e=this.targetWeights()){let t=this.H,n=this.composition,r=Ml(t,e),i=.1+.12*Math.max(0,this.fatGain||0)+.05*Math.max(0,n.muscle);r=Vl(t,r,{armSpread:i,legSpread:.025});let a=1/0,o=-1/0;for(let e=0;e<Wl;e++)a=Math.min(a,r[e*3+1]),o=Math.max(o,r[e*3+1]);let s=this.body.height/(o-a),c=new Float32Array(r.length);for(let e=0;e<r.length;e+=3)c[e]=r[e]*s,c[e+1]=(r[e+1]-a)*s,c[e+2]=r[e+2]*s;let l=e=>Nl(t,c,e),u={hips:l(`pelvis`),chest:l(`spine-2`),neck:l(`neck`),head:l(`head`),shoulderL:l(`l-shoulder`),elbowL:l(`l-elbow`),handL:l(`l-hand`),hipL:l(`l-upper-leg`),kneeL:l(`l-knee`),ankleL:l(`l-ankle`),shoulderR:l(`r-shoulder`),elbowR:l(`r-elbow`),handR:l(`r-hand`),hipR:l(`r-upper-leg`),kneeR:l(`r-knee`),ankleR:l(`r-ankle`),eyeL:l(`l-eye`),eyeR:l(`r-eye`)};return u.spine=u.hips,{pos:c,W:u}}build(){if(!this.H)return;let e=performance.now(),t={};for(let[e,n]of Object.entries(this.joints))t[e]=n.rotation.clone();this.root.traverse(e=>e.isInstancedMesh&&e.dispose());for(let e of Object.values(this.geometries||{}))e.dispose();this.root.clear();let n=this.H,r=this.voxel,{pos:i,W:a}=this.shape(),o=this.joints={},s={},c=(e,t,n)=>{let r=new wn;r.name=e;let i=t===this.root?[0,0,0]:s[t.name];return r.position.set(n[0]-i[0],n[1]-i[1],n[2]-i[2]),t.add(r),o[e]=r,s[e]=n,r};c(`hips`,this.root,a.hips),c(`spine`,o.hips,a.spine),c(`chest`,o.spine,a.chest),c(`neck`,o.chest,a.neck),c(`head`,o.neck,a.head);for(let e of[`L`,`R`])c(`shoulder`+e,o.chest,a[`shoulder`+e]),c(`elbow`+e,o[`shoulder`+e],a[`elbow`+e]),c(`hip`+e,o.hips,a[`hip`+e]),c(`knee`+e,o[`hip`+e],a[`knee`+e]),c(`ankle`+e,o[`knee`+e],a[`ankle`+e]);let l=(e,t)=>Math.hypot(e[0]-t[0],e[1]-t[1],e[2]-t[2]),u=this.lengths={foot:a.ankleL[1],calf:a.kneeL[1]-a.ankleL[1],thigh:a.hipL[1]-a.kneeL[1],upperArm:l(a.shoulderL,a.elbowL),forearmOnly:l(a.elbowL,a.handL)};u.forearm=u.forearmOnly+.1*this.body.height;let d=Hl(i,n.faces,n.N),f=n.faces,p=f.length/3,m=Array(p),h=new Uint8Array(p);for(let e=0;e<p;e++)m[e]=this.vertJoint[f[e*3]],h[e]=this.vertDetail[f[e*3]];let g=r>=.0075?r/2:r,_=[];if(g<r){_.push([r,Ul(i,f,r,null,e=>!h[e])]);let e=e=>{let t=[1/0,1/0,1/0],r=[-1/0,-1/0,-1/0];for(let a=0;a<n.N;a++)if(e(a))for(let e=0;e<3;e++)t[e]=Math.min(t[e],i[a*3+e]),r[e]=Math.max(r[e],i[a*3+e]);return{min:t.map(e=>e-.03),max:r.map(e=>e+.03)}},t=e=>this.vertDetail[e]&&(this.vertJoint[e]===`head`||this.vertJoint[e]===`neck`);for(let n of[t,e=>this.vertHand[e]&&this.vertJoint[e]===`elbowL`,e=>this.vertHand[e]&&this.vertJoint[e]===`elbowR`])_.push([g,Ul(i,f,g,e(n),e=>h[e]&&n(f[e*3]))])}else _.push([r,Ul(i,f,r)]);let v={x:(a.eyeL[0]-a.eyeR[0])/2,y:(a.eyeL[1]+a.eyeR[1])/2,z:(a.eyeL[2]+a.eyeR[2])/2},y=1/0;for(let e=0;e<Wl;e++)this.vertJoint[e]===`head`&&i[e*3+2]>v.z-.01&&Math.abs(i[e*3])<.02&&(y=Math.min(y,i[e*3+1]));let b={eye:v,chinY:y,mouthY:y+.39*(v.y-y),noseY:y+.64*(v.y-y),eyeL:a.eyeL,eyeR:a.eyeR},x=this.body.height/1.75,S={W:a,L:u,face:b,s:x,waistY:a.hipL[1]+.1*x},C={},w={total:0,slow:0,fast:0,fat:0,other:0},T=new Y,E=new K,D=[];for(let[e,t]of _)for(let r of t){let t=f[r.tri*3],i=f[r.tri*3+1],a=f[r.tri*3+2],o=1-r.u-r.v;E.set(d[t*3]*o+d[i*3]*r.u+d[a*3]*r.v,d[t*3+1]*o+d[i*3+1]*r.u+d[a*3+1]*r.v,d[t*3+2]*o+d[i*3+2]*r.u+d[a*3+2]*r.v).normalize();let c=o>=r.u&&o>=r.v?t:r.u>=r.v?i:a,l=m[r.tri],u=n.faceGroup[r.tri]>0,p=this.tissueOf(this.labels[c],c,r,l,u);w.total++,w[p.kind]++;let h=this.colorCube(T,{jn:l,x:r.x,y:r.y,z:r.z,n:E,isEye:u,hand:this.vertHand[c],tissue:p,occ:r.occ,size:e,ctx:S}),g=s[l];(C[l+`|`+e]||=[]).push({p:[r.x-g[0],r.y-g[1],r.z-g[2]],c:T.clone(),n:E.clone(),v:c}),h&&D.push({jn:l,size:e,x:r.x,y:r.y,z:r.z,n:E.clone(),layers:h.layers,color:h.color,jw:g})}let O=new Set;for(let[e,t]of Object.entries(C))for(let n of t)O.add(e+n.p.map(e=>Math.round(e*1e3)).join());for(let e of D)for(let t=1;t<=e.layers;t++){let n=[e.x+e.n.x*e.size*t,e.y+e.n.y*e.size*t,e.z+e.n.z*e.size*t].map(t=>(Math.floor(t/e.size)+.5)*e.size),r=[n[0]-e.jw[0],n[1]-e.jw[1],n[2]-e.jw[2]],i=e.jn+`|`+e.size,a=i+r.map(e=>Math.round(e*1e3)).join();O.has(a)||(O.add(a),(C[i]||=[]).push({p:r,c:new Y(e.color).multiplyScalar(1-.06*t),n:e.n}))}this.body.look.hair.style!==`none`&&this.addHair(C,s,S,g);let k={};for(let[e,t]of Object.entries(C)){let[n,r]=e.split(`|`),i=s[n];for(let e of t)(k[r]||=[]).push({...e,w:[e.p[0]+i[0],e.p[1]+i[1],e.p[2]+i[2]],jn:n})}let A=new Yt;this.geometries={};for(let[e,t]of Object.entries(k)){let n=new _i(+e,+e,+e),r=new Float32Array(t.length*3),i=new Float32Array(t.length*4),a=new Float32Array(t.length*4);t.forEach((e,t)=>{r.set([e.n.x,e.n.y,e.n.z],t*3);let[n,o]=e.v===void 0?[[Kl[e.jn],0,0,0],[1,0,0,0]]:this.cubeWeights(e.v);i.set(n,t*4),a.set(o,t*4)}),n.setAttribute(`instanceNormal`,new ei(r,3)),n.setAttribute(`skinJ`,new ei(i,4)),n.setAttribute(`skinW`,new ei(a,4)),this.geometries[e]=n;let o=new ci(n,this.material,t.length);o.name=`cubes-`+e,o.customDepthMaterial=this.depthMaterial,o.castShadow=o.receiveShadow=!0,o.frustumCulled=!1,t.forEach((e,t)=>{o.setMatrixAt(t,A.makeTranslation(e.w[0],e.w[1],e.w[2])),o.setColorAt(t,e.c)}),o.instanceMatrix.needsUpdate=!0,o.instanceColor&&(o.instanceColor.needsUpdate=!0),this.root.add(o)}this.bindInv=Gl.map(e=>new Yt().makeTranslation(-s[e][0],-s[e][1],-s[e][2]));for(let[e,n]of Object.entries(t))o[e]&&o[e].rotation.copy(n);this.armSpread=0,this.stats=w,this.mesh={pos:i,normals:d,W:a},this.buildMs=performance.now()-e}tissueOf(e,t,n,r,i){if(i||r===`head`||r===`ankleL`||r===`ankleR`)return{kind:`other`};if(this.fatGain>.15&&this.fatSet.has(t)&&e<0)return{kind:`fat`};if(e<0)return{kind:`other`};let a=tu[e];return{kind:Ql(Math.round(n.x/.01),Math.floor(n.y/.04),Math.round(n.z/.01),e)<nu[a]?`slow`:`fast`,group:a}}colorCube(e,t){let{jn:n,x:r,y:i,z:a,n:o,isEye:s,hand:c,tissue:l,occ:u,ctx:d}=t,f=this.body.colors,p=this.body.look,m=p.outfit,{face:h,W:g,L:_,s:v}=d,y=h.eye,b=n===`head`||n===`neck`,x=Math.min(1.05,Math.max(.55,1.18-.7*u));(b||c)&&(x=1-(1-x)*.4);let S=.985+Ql(Math.round(r*400),Math.round(i*400),Math.round(a*400),3)*.03,C=null;if(this.view===`groups`||this.view===`fibers`)return l.kind===`fat`?e.copy(Xl.fat):l.kind===`slow`||l.kind===`fast`?this.view===`groups`?e.set(xl[l.group].color):e.copy(l.kind===`slow`?Xl.slow:Xl.fast):e.copy(b||n.startsWith(`ankle`)?Xl.other:Xl.tendon),e.multiplyScalar(x*S),null;let w=f.skin,T=null,E=Math.abs(r),D=o.z>.25;if(s){let e=r>0?h.eyeL:h.eyeR,t=Math.hypot(r-e[0],i-e[1],a-e[2])||1,n=(a-e[2])/t;n>.985?T=Yl.pupil:n>.82?w=f.eye:T=Yl.eyeWhite}else if(b){let e=p.hair.style,r=i>y.y+.066*v||i>y.y+.05*v&&a<y.z-.01,o=a<y.z-.075*v&&i>y.y-.05*v,s=E>.058*v&&i>y.y+.012*v&&a<y.z-.025*v&&a>y.z-.1*v,c=p.hair.bangs&&i>y.y+.03*v&&a>y.z;e!==`none`&&n===`head`&&(r||o||s||c)&&(w=f.hair);let l=E-y.x,u=y.y+.019*v+.003*v*Math.cos(l/(.02*v)*1.2);n===`head`&&D&&a>y.z&&Math.abs(l)<.019*v&&Math.abs(i-u)<.0026*v*(1-.5*Math.max(0,l/(.019*v)))&&(w=new Y(f.brow).lerp(new Y(f.skin),.25).getHex());let d=.024*v*(this.body.face?.mouthWidth||1),m=i-h.mouthY,g=n===`head`&&D&&a>y.z-.005&&Math.abs(m)<.009*v&&E<d*(1-.5*(m/(.011*v))**2);g&&(w=new Y(f.lip).lerp(new Y(f.skin),Math.abs(m)<.0012*v?0:.2).getHex());let _=n===`head`&&a>y.z-.075*v&&i<h.mouthY+.004*v&&E<.075*v,b=n===`head`&&E<.03*v&&i>h.mouthY+.008*v&&i<h.noseY-.01*v&&a>y.z,x=_&&E<.026*v&&i<h.mouthY-.008*v;!g&&(p.beard===`full`&&(_||b)||p.beard===`goatee`&&(x||b)||p.mustache&&b)?(w=f.beard,C={layers:Math.max(1,Math.round(.006/t.size)),color:f.beard}):p.beard===`stubble`&&!g&&(_||b)&&(w=new Y(f.skin).lerp(new Y(f.beard),.35).getHex())}else{let e=m.top!==`none`,t=m.bottoms===`short`?g.kneeL[1]+.5*_.thigh:m.bottoms===`knee`?g.kneeL[1]-.03*v:g.ankleL[1]+.02*v,s=n===`chest`||n===`spine`||n===`hips`,l=/^(shoulder|elbow)/.test(n);if(s&&i>d.waistY){let t=i>g.neck[1]-.045*v&&Math.hypot(r-g.neck[0],(a-g.neck[2])*.8)<.075*v&&a>g.neck[2]-.01;w=e&&!t?f.shirt:f.skin}else(s||/^(hip|knee)/.test(n))&&i>t&&(w=f.shorts);if(l){let t=g[n.replace(`elbow`,`shoulder`)][1]-i,r=m.sleeves===`long`?9:m.sleeves===`short`?.45*_.upperArm:-1;w=e&&t<r&&!c?f.shirt:f.skin}if(/^knee/.test(n)&&m.shoes&&i<g.ankleL[1]+.05*v&&w===f.skin&&(T=Yl.sock),/^ankle/.test(n)&&(m.shoes?(w=f.shoe,i<.018*v&&(T=Yl.sole)):m.bottoms===`long`&&i>g.ankleL[1]-.01&&(w=f.shorts)),!e&&n===`chest`&&D){let e=Math.hypot(E-g.shoulderL[0]*.55,i-(g.shoulderL[1]-.17*v));e<.011*v&&(T=new Y(f.skin).multiplyScalar(e<.005*v?.62:.8))}!e&&(n===`spine`||n===`chest`)&&o.z>.5&&Math.hypot(r,i-(g.hipL[1]+.125*v))<.006*v&&(T=new Y(f.skin).multiplyScalar(.6))}if(T?e.copy(T):e.set(w),this.composition.tint){l.kind===`fat`&&Math.abs(this.fatGain)>.01&&e.lerp(this.fatGain>0?Zl.fat:Zl.less,Math.min(.3,Math.abs(this.fatGain)*.3));let t=l.group&&this.gains?.[l.group];t&&Math.abs(t)>.02&&e.lerp(t>0?Zl.muscle:Zl.less,Math.min(.3,Math.abs(t)*.25))}return e.multiplyScalar(x*S),C}addHair(e,t,n,r){let{face:i,W:a,s:o}=n,s=this.body.look.hair,c=i.eye,l=s.style,u={short:.008,medium:.02,long:.022}[l]*o*(.8+.2*(s.width||1)),d=.004*o*((s.top||1)-1)*3,f=[0,c.y+.018*o,c.z-.07*o],p=[.083*o,.108*o+d,.103*o],m=l===`short`?c.y-.045*o:l===`medium`?i.chinY-.005*o:a.shoulderL[1]-.14*o,h=new Y(this.body.colors.hair),g=(e,t,n)=>{let r=Math.max(0,t-f[1]);return Math.hypot(e/p[0],r/p[1],(n-f[2])/p[2])},_=(e,t,n)=>{if(t<m||t>f[1]+p[1]+u*1.5)return!1;let r=g(e,t,n),i=1+u/p[0];if(r<1||r>i)return!1;let a=n-f[2],d=s.bangs?c.y+.012*o:c.y+.058*o+.012*o*Math.min(1,Math.abs(e)/(.06*o));return!(a>.03*o&&t<d||l===`short`&&a>-.03*o&&t<c.y+.03*o||l===`short`&&Math.abs(e)>.05*o&&t<c.y+.012*o||l===`short`&&t<c.y-.03*o+.045*o*Math.min(1,Math.abs(e)/(.07*o))||t<f[1]&&a>.02*o)},v=t.head,y=`head|`+r,b=e[y]||=[],x=-p[0]-u-r,S=-x,C=f[2]-p[2]-u-r,w=f[2]+p[2]+u+r,T=e=>(Math.floor(e/r)+.5)*r;for(let e=T(m);e<f[1]+p[1]+u*1.5;e+=r)for(let t=T(x);t<S;t+=r)for(let n=T(C);n<w;n+=r){if(!_(t,e,n)||_(t+r,e,n)&&_(t-r,e,n)&&_(t,e+r,n)&&_(t,e-r,n)&&_(t,e,n+r)&&_(t,e,n-r))continue;let i=new K(t/p[0],Math.max(0,e-f[1])/p[1],(n-f[2])/p[2]).normalize(),a=.86+.14*Ql(Math.round(t/(r*1.5)),Math.round(n/(r*1.5)),11,2);b.push({p:[t-v[0],e-v[1],n-v[2]],c:h.clone().multiplyScalar(a),n:i})}}get voxelCount(){let e=0;return this.root.traverse(t=>{t.isInstancedMesh&&(e+=t.count)}),e}},ou=(e,t,n)=>e.data[n*e.width+t]>.5;function su(e){let t=-1,n=-1;for(let r=0;r<e.height;r++){let i=0;for(let t=0;t<e.width;t++)ou(e,t,r)&&i++;i>2&&(t<0&&(t=r),n=r)}return{top:t,bottom:n}}function cu(e,t,n,r=0,i=e.width-1){t=Math.round(Math.min(e.height-1,Math.max(0,t))),n=Math.round(n);let a=-1;for(let r=0;r<e.width*.05&&a<0;r++)ou(e,n+r,t)?a=n+r:ou(e,n-r,t)&&(a=n-r);if(a<0)return 0;let o=a,s=a;for(;o>0&&ou(e,o-1,t);)o--;for(;s<e.width-1&&ou(e,s+1,t);)s++;return Math.max(0,Math.min(s,i)-Math.max(o,r)+1)}function lu(e,t,n,r,i){let a=1/0;for(let o=.3;o<=.85;o+=.05){let s=cu(e,t+o*(n-t),r,r-i,r+i);s>0&&(a=Math.min(a,s))}return a===1/0?0:a}var uu=(e,t)=>({x:e.landmarks[t].x*e.mask.width,y:e.landmarks[t].y*e.mask.height}),du=(e,t)=>({x:(e.x+t.x)/2,y:(e.y+t.y)/2}),fu=(e,t)=>Math.hypot(e.x-t.x,e.y-t.y),pu=(e,t,n)=>Math.min(n,Math.max(t,e));function mu(e,t){let{mask:n}=e,{top:r,bottom:i}=su(n),a=t/(i-r),o=du(uu(e,11),uu(e,12)),s=du(uu(e,23),uu(e,24)),c=s.y-o.y,l=s.x,u=.045/a,[d,f]=[uu(e,13).x,uu(e,14).x].sort((e,t)=>e-t),[p,m]=[uu(e,15).x,uu(e,16).x].sort((e,t)=>e-t),h=1/0;for(let e=.45;e<=.85;e+=.05)h=Math.min(h,cu(n,o.y+e*c,l,d+u,f-u));let g=cu(n,s.y,l,p+u*.8,m-u*.8),_=uu(e,23),v=uu(e,25),y=_.x<l,b=cu(n,_.y+.3*(v.y-_.y),_.x,y?0:l,y?l:n.width-1),x=(fu(uu(e,11),uu(e,13))+fu(uu(e,13),uu(e,15))+fu(uu(e,12),uu(e,14))+fu(uu(e,14),uu(e,16)))/2,S=(t,r,i,o)=>{let s=uu(e,t),c=uu(e,r),u={x:s.x+(c.x-s.x)*i,y:s.y+(c.y-s.y)*i},d=.09/a,f=u.x-d,p=u.x+d;return o!==void 0&&(u.x<l?p=Math.min(p,l):f=Math.max(f,l)),cu(n,u.y,u.x,f,p)*a},C=e=>(e(0)+e(1))/2,w=(uu(e,9).y+uu(e,10).y)/2,T=t/1.75;return{height:t,neckWidth:pu(lu(n,o.y,w,uu(e,0).x,.08/a)*a,.06*t,.085*t),upperArmWidth:pu(C(e=>S(11+e,13+e,.55)),.045*t,.075*t),forearmWidth:pu(C(e=>S(13+e,15+e,.3)),.038*t,.058*t),calfWidth:pu(C(e=>S(25+e,27+e,.3,!0)),.05*t,.078*t),shoulderWidth:pu(cu(n,o.y+.03*(i-r),l)*a,.22*t,.3*t),waistWidth:pu(h*a,.13*t,.24*t),hipWidth:pu(g*a,.17*t,.26*t),thighWidth:pu(b*a,.07*t,.12*t),legLength:pu((i-s.y)*a,.42*t,.6*t),armLength:pu(x*a,.4*T,.7*T)}}function hu(e,t){let{mask:n}=e,{top:r,bottom:i}=su(n),a=t/(i-r),o=du(uu(e,11),uu(e,12)),s=du(uu(e,23),uu(e,24)),c=s.y-o.y;return t/1.75,{chestDepth:pu(cu(n,o.y+.25*c,s.x)*a,.1*t,.18*t),bellyDepth:pu(cu(n,o.y+.75*c,s.x)*a,.09*t,.2*t)}}var gu=e=>{let t=[...e].sort((e,t)=>e-t),n=t.length>>1;return t.length%2?t[n]:(t[n-1]+t[n])/2};function _u(e){let t={};for(let n of Object.keys(e[0]||{}))t[n]=gu(e.map(e=>e[n]));return t}function vu(e,t){let n=t/1.75,r={...ql};for(let e of Object.keys(r))e!==`height`&&typeof r[e]==`number`&&(r[e]*=n);if(r.height=t,e.front.length){Object.assign(r,_u(e.front.map(e=>mu(e,t))));let n=e.front.find(e=>e.view===`front`)||e.front[0];n.colors&&(r.colors={...r.colors,...n.colors})}e.side.length&&Object.assign(r,_u(e.side.map(e=>hu(e,t)))),r.height=t,r.waistWidth=Math.min(r.waistWidth,r.shoulderWidth*.9),r.hipWidth=Math.min(r.hipWidth,r.shoulderWidth*1.1),r.thighWidth=Math.min(r.thighWidth,r.hipWidth*.55),r.look={...r.look};let i=e.face;if(i&&(r.face=i.measures,Object.assign(r.look,{hair:i.hair,beard:i.beard,mustache:i.mustache}),r.colors={...r.colors,...i.colors}),e.outfit){let t=e.outfit;r.look.outfit={top:t.top,sleeves:t.sleeves,bottoms:t.bottoms,shoes:t.shoes}}return r}var yu=[{key:`weight`,macro:!0,affects:[`waistWidth`,`hipWidth`,`thighWidth`,`bellyDepth`]},{key:`muscle`,macro:!0,affects:[`shoulderWidth`,`upperArmWidth`,`calfWidth`,`chestDepth`]},{key:`shoulder`,targets:[`torso/measure-shoulder-dist`],affects:[`shoulderWidth`]},{key:`bust`,targets:[`torso/measure-bust-circ`],affects:[`chestDepth`,`shoulderWidth`]},{key:`waist`,targets:[`torso/measure-waist-circ`],affects:[`waistWidth`]},{key:`belly`,targets:[`stomach/stomach-pregnant`],affects:[`bellyDepth`]},{key:`hips`,targets:[`torso/measure-hips-circ`],affects:[`hipWidth`]},{key:`thigh`,targets:[`legs/measure-thigh-circ`],affects:[`thighWidth`]},{key:`calf`,targets:[`legs/measure-calf-circ`],affects:[`calfWidth`]},{key:`neck`,targets:[`neck/measure-neck-circ`],affects:[`neckWidth`]},{key:`upperarm`,targets:[`arms/measure-upperarm-circ`],affects:[`upperArmWidth`]},{key:`forearm`,targets:[`arms/l-lowerarm-muscle`,`arms/r-lowerarm-muscle`],affects:[`forearmWidth`]},{key:`legs`,targets:[`legs/measure-upperleg-height`,`legs/measure-lowerleg-height`],affects:[`legLength`]},{key:`arms`,targets:[`arms/measure-upperarm-length`,`arms/measure-lowerarm-length`],affects:[`armLength`]}],bu=[`shoulderWidth`,`waistWidth`,`hipWidth`,`thighWidth`,`legLength`,`armLength`,`neckWidth`,`upperArmWidth`,`forearmWidth`,`calfWidth`],xu=[`chestDepth`,`bellyDepth`],Su={neckWidth:.3,forearmWidth:.5,legLength:2,armLength:1.5};function Cu(e,t){let{pos:n,W:r}=t,i=e.vertJoint,a=e.body.height,o=(r.shoulderL[1]+r.shoulderR[1])/2,s=(r.hipL[1]+r.hipR[1])/2,c=e=>i[e]===`hips`||i[e]===`spine`||i[e]===`chest`,l=(e,t,r=0,i=.008)=>{let a=1/0,o=-1/0;for(let s=0;s<13380;s++){if(Math.abs(n[s*3+1]-e)>i||!t(s))continue;let c=n[s*3+r];c<a&&(a=c),c>o&&(o=c)}return o>a?o-a:0},u=(e,t,n)=>e[1]+(t[1]-e[1])*n,d=(t,n,r,a)=>{let o=u(n,r,a);return l(o,n=>i[n]===t&&!e.vertHand[n],0,.012)},f=(e,t,n)=>{let r=1/0;for(let i=.3;i<=.85;i+=.05){let a=l(e+i*(t-e),n,0,.005);a>0&&(r=Math.min(r,a))}return r===1/0?0:r},p=1/0;for(let e=.45;e<=.85;e+=.05)p=Math.min(p,l(o-e*(o-s),c)||1/0);let m=(e,t)=>Math.hypot(e[0]-t[0],e[1]-t[1],e[2]-t[2]),h=(r.eyeL[1]+r.eyeR[1])/2-a/1.75*.07,g=e=>(e(`L`)+e(`R`))/2;return{shoulderWidth:l(o-.03*a,t=>!e.vertHand[t]),waistWidth:p,hipWidth:l(s,e=>c(e)||/^hip/.test(i[e])),thighWidth:g(e=>d(`hip`+e,r[`hip`+e],r[`knee`+e],.3)),legLength:s,armLength:g(e=>m(r[`shoulder`+e],r[`elbow`+e])+m(r[`elbow`+e],r[`hand`+e])),neckWidth:f(o,h,e=>(i[e]===`neck`||i[e]===`head`)&&Math.abs(n[e*3])<.09),upperArmWidth:g(e=>d(`shoulder`+e,r[`shoulder`+e],r[`elbow`+e],.55)),forearmWidth:g(e=>d(`elbow`+e,r[`elbow`+e],r[`hand`+e],.3)),calfWidth:g(e=>d(`knee`+e,r[`knee`+e],r[`ankle`+e],.3)),chestDepth:l(o-.25*(o-s),c,2),bellyDepth:l(o-.75*(o-s),c,2)}}function wu(e,t,n){let r=performance.now(),i=e.composition;e.composition={...i,fat:0,muscle:0,groups:{}};let a={weight:.5,muscle:.5};for(let e of yu)e.macro||(a[e.key]=0);let o=yu.filter(e=>e.affects.some(e=>n.includes(e))),s=()=>{e.fit={weight:a.weight,muscle:a.muscle,local:{}};for(let t of yu)if(!t.macro)for(let n of t.targets)e.fit.local[n]=a[t.key]},c=()=>{s();let r=Cu(e,e.shape()),i=0;for(let e of n)t[e]>0&&r[e]>0&&(i+=(Su[e]??1)*((r[e]-t[e])/t[e])**2);return i},l=c(),u=1,d=[`legs`,`arms`],f=[{params:o.filter(e=>d.includes(e.key)),steps:[.4,.2,.1,.05]},{params:o.filter(e=>!d.includes(e.key)),steps:[.4,.2,.1,.05]},{params:o,steps:[.05,.025,.0125]}];for(let e of f)for(let t of e.steps)for(let n=0;n<2;n++)for(let n of e.params){let[e,r]=n.macro?[0,1]:[-1,1];for(let i of[1,-1]){let o=a[n.key],s=Math.min(r,Math.max(e,o+i*t));if(s===o)continue;a[n.key]=s;let d=c();if(u++,d<l){l=d;break}a[n.key]=o}}s();let p=Cu(e,e.shape());return e.composition=i,{params:{...a},model:p,error:Math.sqrt(l/Math.max(1,n.length)),evals:u,ms:performance.now()-r}}var Tu=[[`noseWidth`,[`nose/nose-scale-horiz`],3],[`noseLength`,[`nose/nose-scale-vert`],3],[`mouthWidth`,[`mouth/mouth-scale-horiz`],3],[`lipUpper`,[`mouth/mouth-upperlip-volume`],1.5],[`lipLower`,[`mouth/mouth-lowerlip-volume`],1.5],[`eyeSize`,[`eyes/l-eye-scale`,`eyes/r-eye-scale`],3],[`eyeSpacing`,[`eyes/l-eye-trans`,`eyes/r-eye-trans`],3,`in`,`out`],[`faceLong`,[`head/head-scale-vert`],2.5],[`chin`,[`chin/chin-height`],2.5],[`jaw`,[`chin/chin-width`],2.5]];function Eu(e){let t={};if(!e)return t;for(let[n,r,i]of Tu){let a=Math.max(-1,Math.min(1,((e[n]??1)-1)*i));for(let e of r)t[e]=a}return t}var Du=[`spine`,`chest`,`neck`,`head`,`shoulderL`,`shoulderR`,`elbowL`,`elbowR`,`hipL`,`hipR`,`kneeL`,`kneeR`,`ankleL`,`ankleR`];function Ou(e){let t=Math.sin(e*1.6),n=Math.sin(e*.7);return{spine:[.01*t,0,.015*n],chest:[-.02*t,0,-.01*n],head:[.03*Math.sin(e*.5),.15*Math.sin(e*.3),0],shoulderL:[.03*n,0,.02*t],shoulderR:[-.03*n,0,-.02*t],elbowL:[-.08,0,0],elbowR:[-.08,0,0],hipL:[0,0,-.015*n],hipR:[0,0,-.015*n]}}function ku(e){let t=e*Math.PI*2*.9,n=Math.sin(t),r=Math.cos(t),i=e=>.08+.75*Math.max(0,e);return{spine:[.05,.08*n,0],chest:[0,-.14*n,0],head:[0,.06*n,0],hipL:[-.42*n,0,0],hipR:[.42*n,0,0],kneeL:[i(r),0,0],kneeR:[i(-r),0,0],ankleL:[-.15*Math.max(0,r),0,0],ankleR:[-.15*Math.max(0,-r),0,0],shoulderL:[.4*n,0,0],shoulderR:[-.4*n,0,0],elbowL:[-.25-.2*Math.max(0,-n),0,0],elbowR:[-.25-.2*Math.max(0,n),0,0]}}function Au(e){let t=(Math.sin(e*Math.PI*2*.35-Math.PI/2)+1)/2;return t*t*(3-2*t)}function ju(e){let t=Au(e),n=1.35*t,r=.6*t;return{hipL:[-n,0,.06*t],hipR:[-n,0,-.06*t],kneeL:[n+r,0,0],kneeR:[n+r,0,0],ankleL:[-r,0,0],ankleR:[-r,0,0],spine:[.45*t,0,0],chest:[.1*t,0,0],head:[-.45*t,0,0],shoulderL:[-1.35*t-.45*t,0,0],shoulderR:[-1.35*t-.45*t,0,0],elbowL:[-.05,0,0],elbowR:[-.05,0,0]}}var Mu={idle:Ou,walk:ku,squat:ju},Nu=class{constructor(e){this.avatar=e,this.mode=`idle`,this.time=0}update(e){this.time+=e;let t=this.avatar.joints;if(!t.hips)return;let n=Mu[this.mode](this.time),r=1-Math.exp(-e*12);for(let e of Du){let i=t[e];if(!i)continue;let[a,o,s]=n[e]||[0,0,0],c=e===`shoulderL`?s+this.avatar.armSpread:e===`shoulderR`?s-this.avatar.armSpread:s;i.rotation.x+=(a-i.rotation.x)*r,i.rotation.y+=(o-i.rotation.y)*r,i.rotation.z+=(c-i.rotation.z)*r}this.placeOnFloor()}placeOnFloor(){let{joints:e,lengths:t}=this.avatar,n=0,r=0;for(let i of[`L`,`R`]){let a=e[`hip`+i].rotation.x,o=a+e[`knee`+i].rotation.x,s=t.thigh*Math.cos(a)+t.calf*Math.cos(o)+t.foot;s>n&&(n=s,r=-t.thigh*Math.sin(a)-t.calf*Math.sin(o))}e.hips.position.y=n,e.hips.position.z=this.mode===`squat`?-r:e.hips.position.z*.9}},Pu=`modulepreload`,Fu=function(e,t){return new URL(e,t).href},Iu={},Lu=function(e,t,n){let r=Promise.resolve();if(t&&t.length>0){let e=document.getElementsByTagName(`link`),i=document.querySelector(`meta[property=csp-nonce]`),a=i?.nonce||i?.getAttribute(`nonce`);function o(e){return Promise.all(e.map(e=>Promise.resolve(e).then(e=>({status:`fulfilled`,value:e}),e=>({status:`rejected`,reason:e}))))}function s(e){return import.meta.resolve?import.meta.resolve(e):new URL(e,import.meta.url).href}r=o(t.map(t=>{if(t=Fu(t,n),t=s(t),t in Iu)return;Iu[t]=!0;let r=t.endsWith(`.css`);for(let n=e.length-1;n>=0;n--){let i=e[n];if(i.href===t&&(!r||i.rel===`stylesheet`))return}let i=document.createElement(`link`);if(i.rel=r?`stylesheet`:Pu,r||(i.as=`script`),i.crossOrigin=``,i.href=t,a&&i.setAttribute(`nonce`,a),document.head.appendChild(i),r)return new Promise((e,n)=>{i.addEventListener(`load`,e),i.addEventListener(`error`,()=>n(Error(`Unable to preload CSS for ${t}`)))})}).filter(e=>e!==void 0))}function i(e){let t=new Event(`vite:preloadError`,{cancelable:!0});if(t.payload=e,window.dispatchEvent(t),!t.defaultPrevented)throw e}return r.then(t=>{for(let e of t||[])e.status===`rejected`&&i(e.reason);return e().catch(i)})},Ru=()=>Lu(()=>import(`./scan-BZC7X8mH.js`),__vite__mapDeps([0,1]),import.meta.url),zu=document.getElementById(`stage`),Bu=new Qc({antialias:!0});Bu.setPixelRatio(Math.min(window.devicePixelRatio,2)),Bu.toneMapping=4,Bu.toneMappingExposure=1.05,Bu.shadowMap.enabled=!0,Bu.shadowMap.type=1,zu.appendChild(Bu.domElement);var Vu=new Mn;Vu.background=new Y(1777188);var Hu=new da(35,1,.05,100);Hu.position.set(0,1.15,3.6);var Uu=new cl(Hu,Bu.domElement);Uu.target.set(0,.95,0),Uu.enableDamping=!0,Uu.minDistance=.4,Uu.maxDistance=8,window.camera=Hu,window.controls=Uu,Vu.add(new $i(14674175,3814448,.55));var Wu=new ma(16773344,2.4);Wu.position.set(1.6,3.2,2.6),Wu.castShadow=!0,Wu.shadow.mapSize.set(2048,2048),Object.assign(Wu.shadow.camera,{left:-1.1,right:1.1,top:2.1,bottom:-.2,near:.5,far:8}),Wu.shadow.bias=-.001,Wu.shadow.normalBias=.025,Wu.shadow.radius=3,Vu.add(Wu);var Gu=new ma(12374783,.7);Gu.position.set(-2.5,1.8,1.5),Vu.add(Gu);var Ku=new ma(16777215,.9);Ku.position.set(-.5,2.5,-3),Vu.add(Ku);var qu=new Xr(new vi(1.3,64),new Ai({color:2764342,roughness:.95}));qu.rotation.x=-Math.PI/2,qu.receiveShadow=!0,Vu.add(qu);var Ju=new au;Vu.add(Ju.root),window.avatar=Ju;var Yu=new Nu(Ju);window.animator=Yu;var Xu=performance.now();function Zu(){let e=zu.clientWidth,t=zu.clientHeight;Bu.setSize(e,t),Hu.aspect=e/t,Hu.updateProjectionMatrix()}new ResizeObserver(Zu).observe(zu),Zu(),Bu.setAnimationLoop(()=>{let e=performance.now();Yu.update(Math.min((e-Xu)/1e3,.1)),Ju.updateSkin(),Xu=e,Uu.update(),Bu.render(Vu,Hu)});var $=e=>document.getElementById(e),Qu=$(`status`),$u=e=>Qu.textContent=e,ed={front:[],side:[],face:null,outfit:null},td={};window.scans=ed;var nd={front:`Front`,back:`Rücken`,side:`Seite`};async function rd(e,t){$u(`Analysiere `+nd[e]+` … (erstes Mal lädt die Modelle)`);try{let{analyze:n,drawScan:r,scanQuality:i}=await Ru(),a=await n(t);if(r($(e===`side`?`prevSide`:`prevFront`),t,a),!a)return $u(`Keine Person erkannt. Ganzer Körper im Bild?`);a.view=e,(e===`side`?ed.side:ed.front).push(a);let o=``;if(e===`front`&&(!ed.outfit&&a.outfit&&(ed.outfit=a.outfit),!ed.face)){$u(`Analysiere Gesicht …`);let{analyzeFace:e,drawFace:n}=await Lu(async()=>{let{analyzeFace:e,drawFace:t}=await import(`./face-DGfXcQ_N.js`);return{analyzeFace:e,drawFace:t}},__vite__mapDeps([2,1]),import.meta.url);try{a.face=await e(t,a.landmarks)}catch(e){console.warn(`face analysis failed`,e)}a.face&&(ed.face=a.face,n($(`prevFace`),a.face),xd={}),o=a.face?`, Gesicht erkannt`:`, Gesicht nicht erkannt`}td[e]=i(a,e===`back`?`front`:e),$(`tips`).innerHTML=[...new Set(Object.values(td).flat())].map(e=>`<li>${e}</li>`).join(``),$u(nd[e]+` erkannt ✓`+o+` – Körpermodell wird angepasst …`),await new Promise(e=>setTimeout(e,30)),pd(),$u(nd[e]+` erkannt ✓`+o+` – Avatar angepasst`)}catch(e){console.error(e),$u(`Fehler bei der Analyse: `+e.message)}}function id(){let e=ed.front.filter(e=>e.view===`back`).length,t=ed.front.length-e,n=ed.side.length;$(`scanCount`).textContent=t+e+n?`Aufnahmen: ${t}× Front, ${e}× Rücken, ${n}× Seite – Maße = Median aller Aufnahmen.`:`Noch keine Aufnahmen. Mehr Aufnahmen = genauere Maße (Median).`}for(let[e,t]of[[`front`,`fileFront`],[`back`,`fileBack`],[`side`,`fileSide`]]){let n=$(t);n.addEventListener(`change`,async()=>{let{loadImageFile:t}=await Ru();for(let r of[...n.files])await rd(e,await t(r));n.value=``,id()})}$(`clearScans`).addEventListener(`click`,()=>{ed.front.length=0,ed.side.length=0,ed.face=null,ed.outfit=null;for(let e of Object.keys(td))delete td[e];$(`tips`).innerHTML=``,id(),pd(),$u(`Aufnahmen gelöscht.`)});var ad=$(`video`),od=!1,sd=`user`;$(`camBtn`).addEventListener(`click`,async()=>{let{startCamera:e,stopCamera:t,loadPose:n}=await Ru();if(od)t(ad),od=!1;else try{await e(ad,sd),od=!0,n()}catch(e){console.warn(e),$u(`Kamera nicht verfügbar (Erlaubnis? HTTPS?). Foto wählen geht immer.`)}ad.parentElement.hidden=!od,$(`camBtn`).textContent=od?`Kamera stoppen`:`Kamera starten`,$(`snapFront`).disabled=$(`snapBack`).disabled=$(`snapSide`).disabled=!od,$(`flipCam`).hidden=!od,ad.classList.toggle(`mirror`,sd===`user`)}),$(`flipCam`).addEventListener(`click`,async()=>{sd=sd===`user`?`environment`:`user`;let{startCamera:e}=await Ru();try{await e(ad,sd)}catch(e){console.warn(e),$u(`Diese Kamera ist nicht verfügbar.`)}ad.classList.toggle(`mirror`,sd===`user`)});async function cd(e){let t=$(`countdown`);for(let n=e;n>0;n--)t.textContent=n,await new Promise(e=>setTimeout(e,1e3));t.textContent=``}for(let[e,t,n]of[[`front`,`snapFront`,`Frontal zur Kamera stellen …`],[`back`,`snapBack`,`Rücken zur Kamera drehen …`],[`side`,`snapSide`,`Seitlich zur Kamera stellen …`]])$(t).addEventListener(`click`,async()=>{$u(n),await cd(5);let{captureFrame:t}=await Ru();od&&(await rd(e,t(ad)),id())});var ld=$(`height`),ud=[[`shoulderWidth`,`Schulterbreite`],[`waistWidth`,`Taillenbreite`],[`hipWidth`,`Hüftbreite`],[`thighWidth`,`Oberschenkel`],[`calfWidth`,`Wade`],[`upperArmWidth`,`Oberarm`],[`forearmWidth`,`Unterarm`],[`neckWidth`,`Hals`],[`legLength`,`Beinlänge`],[`armLength`,`Armlänge`],[`chestDepth`,`Brusttiefe`,`side`],[`bellyDepth`,`Bauchtiefe`,`side`]],dd=null;function fd(e){let t=e=>e>0?(e*100).toFixed(1)+` cm`:`–`,n=dd?.model,r=ud.map(([r,i,a])=>{let o=a===`side`?ed.side.length:ed.front.length;return`<tr><td>${i}</td><td>${o?`${t(e[r])} <span class="src">${o}×</span>`:`<span class="src">kein Foto</span>`}</td><td>${n?t(n[r]):``}</td></tr>`});$(`measures`).innerHTML=`<tr><td>Größe</td><td colspan="2">${t(e.height)} <span class="src">eingegeben</span></td></tr>`+(n?`<tr class="head"><td></td><td>Foto</td><td>Modell</td></tr>`:``)+r.join(``)+(dd?`<tr><td colspan="3" class="src">Modell-Abweichung im Mittel ${(dd.error*100).toFixed(1)} % (${Math.round(dd.ms)} ms)</td></tr>`:``)}function pd(){let e=vu(ed,Math.min(220,Math.max(120,Number(ld.value)||175))/100);e.look={...e.look,...xd.look,hair:{...e.look.hair,...xd.look?.hair},outfit:{...e.look.outfit,...xd.look?.outfit}},e.colors={...e.colors,...xd.colors},Ju.body=e,Ju.person={gender:Number($(`gender`).value),age:Number($(`age`).value)||30};let t=[...ed.front.length?bu:[],...ed.side.length?xu:[]];Ju.H&&t.length?dd=wu(Ju,e,t):(Ju.fit={weight:.5,muscle:.5,local:{}},dd=null),Ju.fit.face=Eu(ed.face?.measures),yd(),fd(e),wd(e)}ld.addEventListener(`change`,pd);for(let e of[`gender`,`age`])$(e).addEventListener(`change`,pd);var md=e=>(e>0?`+`:``)+e+` %`,hd=e=>`#`+e.toString(16).padStart(6,`0`);$(`groupSliders`).innerHTML=Object.entries(xl).map(([e,t])=>`
  <label class="slider">
    <span><span><i class="chip" style="background:${hd(t.color)}"></i>${t.label}</span><output id="gOut-${e}">0 %</output></span>
    <input type="range" data-group="${e}" min="-100" max="100" value="0" step="5">
  </label>`).join(``);var gd=[...document.querySelectorAll(`#groupSliders input`)],_d={look:`<i style="background:#ffa040"></i>mehr Fett <i style="background:#e53935"></i>mehr Muskeln <i style="background:#4fa8e8"></i>weniger`,groups:Object.values(xl).map(e=>`<i style="background:${hd(e.color)}"></i>${e.label}`).join(` `)+` <i style="background:#f4d35e"></i>Fettdepot <i style="background:#d9d2c5"></i>Sehne/Knochen`,fibers:`<i style="background:#8e1b1b"></i>langsame Fasern (Typ I, Ausdauer) <i style="background:#f0b8b0"></i>schnelle Fasern (Typ II, Kraft) <i style="background:#f4d35e"></i>Fett`},vd=!1;function yd(){vd||(vd=!0,requestAnimationFrame(()=>{vd=!1,Ju.build();let e=Ju.stats,t=e=>e.toLocaleString(`de-DE`),n=e.slow+e.fast;$(`stats`).textContent=`${t(Ju.voxelCount)} Würfel (${Math.round(Ju.buildMs)} ms) · sichtbar: ${t(n)} Muskel (${n?Math.round(e.slow/n*100):0} % langsam), ${t(e.fat)} Fett`}))}function bd(e=!1){let t=Number($(`fat`).value),n=Number($(`muscle`).value);$(`fatOut`).textContent=md(t),$(`muscleOut`).textContent=md(n);let r={};for(let e of gd)r[e.dataset.group]=Number(e.value)/100,$(`gOut-`+e.dataset.group).textContent=md(Number(e.value));Object.assign(Ju.composition,{fat:t/100,muscle:n/100,groups:r,training:$(`training`).value,tint:$(`tint`).checked}),Ju.view=$(`view`).value;let i=Number($(`voxel`).value);Ju.voxel=e?Math.max(i,.02):i,$(`legend`).innerHTML=_d[Ju.view],yd()}for(let e of[$(`fat`),$(`muscle`),...gd])e.addEventListener(`input`,()=>bd(!0)),e.addEventListener(`change`,()=>bd(!1));for(let e of[`training`,`tint`,`view`,`voxel`])$(e).addEventListener(`change`,()=>bd());$(`resetComp`).addEventListener(`click`,()=>{for(let e of[$(`fat`),$(`muscle`),...gd])e.value=0;bd()}),bd();for(let e of document.querySelectorAll(`#modes button`))e.addEventListener(`click`,()=>{Yu.mode=e.dataset.mode,document.querySelectorAll(`#modes button`).forEach(t=>t.classList.toggle(`active`,t===e))});var xd={},Sd=e=>`#`+e.toString(16).padStart(6,`0`),Cd={colSkin:`skin`,colHair:`hair`,colEye:`eye`,colLip:`lip`,colShirt:`shirt`,colShorts:`shorts`};function wd(e){let t=e.look;$(`hairStyle`).value=t.hair.style,$(`bangs`).checked=!!t.hair.bangs,$(`beard`).value=t.beard,$(`mustache`).checked=!!t.mustache;let n=t.outfit;$(`top`).value=n.top===`none`?`none`:n.sleeves===`long`?`long`:n.sleeves===`none`?`tank`:`short`,$(`bottoms`).value=n.bottoms,$(`shoes`).checked=!!n.shoes;for(let[t,n]of Object.entries(Cd))$(t).value=Sd(e.colors[n]);let r=ed.face;if(r){let e=e=>Math.round(e*100)+` %`,t=r.measures;$(`faceInfo`).textContent=`Gesicht erkannt (100 % = Durchschnitt): Länge ${e(t.faceLong)}, Kiefer ${e(t.jaw)}, Augenabstand ${e(t.eyeSpacing)}, Augen ${e(t.eyeSize)}, Nase ${e(t.noseWidth)} breit / ${e(t.noseLength)} lang, Mund ${e(t.mouthWidth)}, Lippen ${e((t.lipUpper+t.lipLower)/2)}, Kinn ${e(t.chin)}.`}}function Td(){xd.look={hair:{style:$(`hairStyle`).value,bangs:$(`bangs`).checked},beard:$(`beard`).value,mustache:$(`mustache`).checked,outfit:{top:$(`top`).value===`none`?`none`:`shirt`,sleeves:{none:`none`,short:`short`,long:`long`,tank:`none`}[$(`top`).value],bottoms:$(`bottoms`).value,shoes:$(`shoes`).checked}},xd.colors={};for(let[e,t]of Object.entries(Cd))xd.colors[t]=parseInt($(e).value.slice(1),16);xd.colors.hair!==Ju.body.colors.hair&&(xd.colors.beard=xd.colors.brow=xd.colors.hair),pd()}for(let e of[`hairStyle`,`beard`,`bangs`,`mustache`,`top`,`bottoms`,`shoes`,...Object.keys(Cd)])$(e).addEventListener(`change`,Td);pd(),Ju.ready.then(()=>pd());export{Lu as t};